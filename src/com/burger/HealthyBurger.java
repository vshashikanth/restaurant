...
public class HealthyBurger extends BaseBurger {
    ...
    static private String[] additionals=new String[6];
    static private double[] additionals_price=new double[6];
    public HealthyBurger() {}
    public HealthyBurger(String bread_roll_type,double burger_price) {
       // System.out.println("you have entered into HealthyBurger parametarized constructor. ");
